...
your changes just delete your database files, or just run:
  ...
  cd /Users/jono/Python/MixedMotionCueingEffects
  klibs db-rebuild
...
destroyed and rebuilt. If you wish to keep the data you currently have, be sure to first run:
  ...
  klibs export /Users/jono/Python/MixedMotionCueingEffects

This will export the database in it's current state to text files found in /Users/jono/Python/ExpAssets/Data.
...
CREATE TABLE saccades (
	id integer primary key autoincrement not null,
	participant_id integer key not null,
	trial_id integer key not null,
	rt float not null,
	accuracy text not null,
	dist_from_target float not null,
